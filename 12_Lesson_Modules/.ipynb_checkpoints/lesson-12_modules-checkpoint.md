...
# main.py file
import mymodule
print(mymodule.generate_full_name('Pavlo', 'Radiuk')) # Pavlo Radiuk
```
...
print(generate_full_name('Pavlo','Radiuk'))
...
```sh
python script.py Pavlo Python Programming
```

The result:

```sh
Welcome Pavlo. Enjoy Python Programming Course! 
```
...
🌕 You are going far. Keep going! You have just completed lesson 12 and you are 12 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
