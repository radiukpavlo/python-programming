[<< Lesson 18](../18_Lesson_Regular_expressions/lesson-18_regular_expressions.md)
...
person_dct= {
    ...
    "country":"Ukraine",
    "city":"Kyiv",
    "skills":["PyTorch", "JupyterNotebook", "Python"]
}
# JSON: A string form a dictionary
person_json = "{'name': 'Pavlo', 'country': 'Ukraine', 'city': 'Kyiv', 'skills': ['PyTorch', 'JupyterNotebook', 'Python']}"
...
# output
<class 'dict'>
{'name': 'Pavlo', 'country': 'Ukraine', 'city': 'Kyiv', 'skills': ['PyTorch', 'JupyterNotebook', 'Python']}
Pavlo
```
...
Column names are :name, country, city, skills
        Pavlo is a teacher. He lives in Ukraine, Kyiv.
Number of lines:  2
```
...
6. Use the function, find_most_frequent_words to find:
   a) The ten most frequent words used in [Obama's speech](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/obama_speech.txt)
   b) The ten most frequent words used in [Michelle's speech](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/michelle_obama_speech.txt)
   c) The ten most frequent words used in [Trump's speech](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/donald_speech.txt)
   d) The ten most frequent words used in [Melina's speech](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/melina_trump_speech.txt)
7. Write a python application that checks similarity between two texts. It takes a file or a string as a parameter and it will evaluate the similarity of the two texts. For instance check the similarity between the transcripts of [Michelle's](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/michelle_obama_speech.txt) and [Melina's](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/melina_trump_speech.txt) speech. You may need a couple of functions, function to clean the text(clean_text), function to remove support words(remove_support_words) and finally to check the similarity(check_text_similarity). List of [stop words](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/stop_words.py) are in the data directory
8. Find the 10 most repeated words in the romeo_and_juliet.txt
9. Read the [hacker news csv](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/data/hacker_news.csv) file and find out:
   a) Count the number of lines containing python or Python
   b) Count the number lines containing PyTorcht, PyTorcht or PyTorcht
   c) Count the number lines containing Java and not PyTorcht

### Exercises: Level 3

🎉 CONGRATULATIONS ! 🎉

[Lesson 20 >>](../20_Lesson_Python_package_manager/lesso-020_python_package_manager.md)
