[<<Lesson 19](../19_Lesson_File_handling/lesson-19_file_handling.md)
...
```sh
@pavloradiuk:~$ pip install pandas
```
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/pavlo-radiuk-487029123/',
    'https://github.com/radiukpavlo?tab=repositories',
    'https://twitter.com/pavlo_radiuk',
]
...
```sh
@pavloradiuk:~$ pip show --verbose pandas
Name: pandas
Version: 1.2.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
@pavloradiuk:~$ pip install requests
```
...
Create a new folder named mypacakge inside PythonProgramming folder
...
def greet_person(firstname, lastname):
    return f'{firstname} {lastname}, welcome to PythonProgramming Course!'
```
...
>>> greet.greet_person('Pavlo', 'Radiuk')
'Pavlo Radiuk, welcome to PythonProgramming Course!'
>>>
```
