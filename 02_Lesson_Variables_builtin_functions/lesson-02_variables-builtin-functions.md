...
🌕 You are awesome. You have just completed lesson
2 challenges and you are two steps ahead on your way to greatness. Now do some exercises for your brain and muscles.

## 💻 Exercises - Lesson 2

### Exercises: Level 1

1. Inside folder PythonProgramming create a subfolder called lesson_2. Inside this folder create a file named variables.py
2. Write a python comment saying 'Lesson 2: the python programming course'
...
🎉 CONGRATULATIONS ! 🎉 You have finished lesson 2 of this course!
