[<< Lesson 16](../16_Lesson_Python_date_time/lesson-16_python_datetime.md)
...
![Try and Except](https://raw.githubusercontent.com/radiukpavlo/python-programming/main/images/try_except.png)
...
1. names = ['Finland', 'Sweden', 'Norway','Denmark','Iceland', 'Estonia']. Unpack the first five countries and store them in a variable _nordic_countries_, store Swedeb and Estonia in SWE and ES, respectively.
